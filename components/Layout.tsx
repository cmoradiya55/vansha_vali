...
//         {/* Header */}
//         <header
//           className="bg-yellow-900 text-white shadow-md sticky top-0 z-40"
//           style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}
//         >
//           <div className="flex items-center justify-between px-2 sm:px-4 py-2 sm:py-3 min-h-[48px] sm:min-h-[56px]">
...
//         {/* Page Content */}
//         {/* className="flex-1 overflow-y-auto bg-white p-2 sm:p-4 " */}
//         <main id="page-content" className="bg-white overflow-y-auto">
//           {children}
//         </main>
//       </div>
