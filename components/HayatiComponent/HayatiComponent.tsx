...
import FamilyTree from '@/components/HayatiComponent/HayatiFamilyTree';
import { generateHayatiPDF } from './HayatiPdfGenerator';
...
export default function HayatiComponent() {
  const { user } = useAuth();
  ...
  const handleDownloadTemplatePDF = async () => {
    ...
    try {
      ...
      const result = await generateHayatiPDF(templateData);
  ...
  return (
    <div id="pedhinama" className="mx-auto space-y-4 sm:space-y-6 px-2 sm:px-4">
      ...
      <div className="flex justify-center items-center mb-4 sm:mb-6 pb-2">
        <h1 className="text-lg sm:text-xl font-bold text-black pt-4">હયાતી</h1>
      </div>
      ...
      <div className="rounded-lg border border-gray-300 bg-white p-2 sm:p-3">
        ...
        <div className="flex flex-wrap items-baseline gap-x-1 gap-y-0.5 text-xs sm:text-sm text-black declaration-flow leading-7">
          <span>હું નીચે સહિ કરનાર (અરજદાર) આજરોજ તલાટી કમ મંત્રી </span>
          <div className="flex flex-col inline-flex items-start declaration-value">
            <span className="font-medium -mb-0.5 text-left min-w-[4rem]">{formData.moje}</span>
            <div className="w-20 border-b border-black mt-0.5"></div>
          </div>
          <span> તા. </span>
          <div className="flex flex-col inline-flex items-start declaration-value">
            <span className="font-medium -mb-0.5 text-left min-w-[4rem]">{formData.taluko}</span>
            <div className="w-20 border-b border-black mt-0.5"></div>
          </div>
          <span> જી. </span>
          <div className="flex flex-col inline-flex items-start declaration-value">
            <span className="font-medium -mb-0.5 text-left min-w-[4rem]">{formData.jillo}</span>
            <div className="w-20 border-b border-black mt-0.5"></div>
          </div>
          <span> રૂબરૂ હાજર થઈ પૂછવાથી લખાવું છે કે હું પોતે </span>
          ...
          <span> હયાત છું અને આ પેઢીનામું </span>
          ...
          <span> ના કામે જરૂર હોય પેઢીનામું મેળવવા માટે, તારીખ </span>
          ...
          <span className="declaration-inline"> ના રોજ અમોએ અરજી કરેલી છે, </span>
          <p className="declaration-body w-full mt-1"> તે અરજી અન્વયે આજરોજ પંચો રૂબરૂ હાજર રહિ લખાવું છે કે, મારા સીધીલીટી ના ઉપરોકત દર્શાવ્યા સિવાયના અન્ય કોઈ વારસદરો બાકી રહેતા નથી. તેમ છતા ભવિષ્યમાં કોઈ વારસદરો નિકળે તો તેની તમામ જવાબદારી મારી પોતાની રહેશે. અને જો પેઢીનામું ખોટું ઠરે તો તેમાં અમે અરજદાર તથા પંચો જવાબદાર રહેશું અમોએ ખોટા વારસદરો બતાવેલ નથી તથા સાચા વારસદરો બાકી રાખેલ નથી. ખોટું પેઢીનામું લખાવવું એ ફોજદારી ગુનો બને છે જેની અમો ને જાણ છે. આ પેઢીનામાં બાબતે રૂબરૂ માં સહી કરનાર તલાટી કમ મંત્રી જવાબદાર નથી.</p>
          <p className="declaration-body w-full"> ઉપર મુજબનું પેઢીનામું અમો પંચોના લખાવ્યા મુજબનું શુધ્ધ બુધ્ધિથી અકકલ હોશિયારીથી કોઈપણ જાતના દાબ-દબાણ લોભ-લાલચ સિવાયનું લખાવ્યા મુજબનું સાચું અને ખરું છે, જે અમોએ વાંચી સમજી સાંભળી વિચારીને નીચે સહી કરી આપેલ છે. જે મને કબૂલ મંજૂર છે.</p>
        </div>
